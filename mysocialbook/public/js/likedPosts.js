...
function generatePostContentHTML(postBody, postImage, postId, isLiked) {
    ...
    //second action item
    const shareItem = generateActionItemBySvgPath('M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z');
    shareItem.addEventListener('click', () =>{
        const link = "http://127.0.0.1:8000/post/" + postId;
        copyLink(link);
        alert('Link copiato');
    });
    actionsMenu.appendChild(shareItem);
...
function generatePostFooterHTML(postId) {
    ...
    viewActivitiesLink.href = "post/" + postId;
